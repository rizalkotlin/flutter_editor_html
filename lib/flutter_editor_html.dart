...
class FlutterEditorHmtl extends StatefulWidget {
  final String? value;
  final double? height;
  ...
  @override
  FlutterEditorHmtlState createState() => FlutterEditorHmtlState();
}

class FlutterEditorHmtlState extends State<FlutterEditorHmtl> {
  String text = '';
  late String _page;
